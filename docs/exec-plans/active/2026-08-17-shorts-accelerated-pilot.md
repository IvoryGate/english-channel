...
- Publish at 08:00 and 20:30 Asia/Shanghai during the accelerated pilot.
...
- `configs/shorts/product.json`: accelerated cadence and publishing slots.
...
- Codex automation `shorts`: twice-daily production, upload, and review loop.
