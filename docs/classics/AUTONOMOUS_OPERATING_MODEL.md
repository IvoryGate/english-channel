...
The shared channel policy is the upper bound. A product-level authority value
cannot grant a mutation disabled by channel policy. The current tracked state
is level 0 with public scheduling disabled.
