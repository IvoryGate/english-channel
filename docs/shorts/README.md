...
- Tuesday 20:30 Asia/Shanghai;
- Thursday 08:00 Asia/Shanghai;
- Saturday 20:30 Asia/Shanghai;
- no more than one upload per day;
- no more than five total channel uploads per week, including long form.

The two time bands are controlled scheduling variants, not assumptions about
the best hour. The weekly review may replace them after sufficient evidence.
